...
const AirtimeBillsSummaryScreen
  = (props: Props) => {
    const {
    } = props;
    ...
    const makePurchase = async () => {
      try {
        ...
        const res = await axiosExtended.post(`${routes.bills}/airtime/payment`, payload);
        if (res.status === 200) {
    ...
    return (
      <SafeAreaView
        ...
        <ConfirmModal
          ...
          title="Congratulations, Airtime bill payment was sucessful."
...
export default AirtimeBillsSummaryScreen
