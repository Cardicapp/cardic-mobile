  ...
  = (props: Props) => {
    ...
    const makePurchase = async () => {
      try {
        ...
        const res = await axiosExtended.post(`${routes.bills}/electricity/payment`, payload);
        if (res.status === 200) {
          console.log("Vend res.data: ", res.data)
    ...
    return (
      <SafeAreaView
        ...
        <ConfirmModal
          ...
          title="Congratulations, electricity bill payment was sucessful."
...
export default ElectricityBillSummary
