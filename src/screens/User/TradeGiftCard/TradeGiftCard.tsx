...
import { useGetGiftCardsQuery } from '../../../services/modules/giftcards';
import { useInitiateTradeMutation } from '../../../services/modules/trades';
...
const SellGiftCardFlowScreen = () => {
    ...
    const { data: giftCards = [] } = useGetGiftCardsQuery();
    const [initiateTrade, { isLoading: isInitiating }] = useInitiateTradeMutation();
    ...
    const handleAmountChange = (value: string) => {
        ...
        if (numeric && selectedCard) {
            const payout = Number(numeric) * selectedCard.numericRate;
                    ...
                    >
                        ...
                        >
                            ...
                            <View style={styles.form}>
                                {/* Choose Category */}
                                <AppText style={styles.label}>Choose Category</AppText>
                                <TouchableOpacity
                                ...
                                >
                                    ...
                                    <Ionicons
                                        name={showCategories ? 'caret-up-outline' : 'caret-down-outline'}
                                        size={18}
                                        color="#9AC23C"
                                    />
                                </TouchableOpacity>
                                ...
                                <AppText style={styles.currentRate}>
                                    Current Rate: ₦{selectedCard.numericRate}/$
                                </AppText>
                            </View>
                            {/* Footer Button */}
                            <View
                        ...
                        <TouchableOpacity
                            ...
                            onPress={async () => {
                                try {
                                    ...
                                    const trade = await initiateTrade({
                                    ...
                                    setShowModal(false);
                                    // @ts-ignore
                                    navigation.navigate('TradeChatScreen', { tradeId: trade.id });
                                } catch (error) {
