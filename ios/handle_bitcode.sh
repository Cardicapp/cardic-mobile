...
# This script checks for Bitcode in iOS frameworks, strips it if found,
# and replaces the original frameworks with the stripped versions.

# It also disables Bitcode in the Xcode project and rebuilds it.
# Ensure the script is run from the root of the project
# and that you have the necessary permissions to modify files.

# https://stackoverflow.com/a/79000179
